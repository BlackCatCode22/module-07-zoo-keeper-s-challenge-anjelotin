...
class Bear(Animal):
    ...
    def __init__(self, name="a_name", animal_id="an_id", birth_date="2099-01-01", color="a_color", sex="a_sex",
        ...
        # Increment the static variable numOfBears when a new Hyena object is created
        Bear.numOfBears += 1
    ...
    # the hyena object will call this method to get an unused bear name. pop() will remove the first element from
